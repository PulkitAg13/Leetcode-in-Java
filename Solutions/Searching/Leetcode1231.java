...
// 1231. Divide Chocolate - This is Leetcode Hard Problem and its locked.
...
// We can use binary search to find the maximum sweetness that we can get by cutting the chocolate bar into K+1 pieces.
// We will check if we can split the chocolate bar into K+1 pieces with at least the target sweetness. 
// If we can, we will try to increase the target sweetness, otherwise, we will decrease it.
